...
def main() -> None:
    ...
    if not args.structural_only:
        ...
        communication = CommunicationScenario.load(args.communication_model, args.scenario)
    ...
    write_predictions(
        predictions,
        args.output,
        timing_verdict=(communication.validation_verdict if communication else None),
    )
