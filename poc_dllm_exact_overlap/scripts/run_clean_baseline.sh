...
dataset_name="$1"
repeat="$2"
result_root="${3:-/home/esjung/MLLM-EP-exact-overlap/poc_dllm_exact_overlap/results/exact_overlap_20260913_134622}"
...
out="$result_root/clean/$dataset_name/r${repeat}"
