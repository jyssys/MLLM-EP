...
export PYTHONPATH="${study_root}/instrumentation:${PYTHONPATH:-}"
export EP_UNMASK_ATLAS_DIR="${result_dir}/unmask"
export LLADA_DENOISE_TRACE=1
export LLADA_EP_TRACE_DIR="${result_dir}/ep"
export LLADA_EP_TRACE_LAYERS="$layers"
export LLADA_EP_TRACE_ROUTES=1
export SGL_ENABLE_JIT_DEEPGEMM=false
export SGLANG_ENABLE_JIT_DEEPGEMM=false
export SGLANG_DEEPEP_NUM_MAX_DISPATCH_TOKENS_PER_RANK=1024

# nvidia-smi uses physical indexes; the benchmark --gpu indexes are logical.
