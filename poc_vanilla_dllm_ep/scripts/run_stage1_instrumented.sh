...
OUT="$ROOT/poc_vanilla_dllm_ep/results/stage0_instrumented"
...
run_one() {
  ...
  local stem="vanilla_ep${ep}_instrumented"
...
# Interleave the endpoints around EP2 to reduce monotonic warm-machine bias.
run_one 4
run_one 1
run_one 2
