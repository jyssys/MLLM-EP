...
run_one() {
  ...
  local stem="vanilla_ep${ep}_restart${restart}"
...
# The initial launcher completed restart-2 EP4, then exposed an EP1 fused
# conversion peak-memory regression.  Resume the uncompleted Latin-order tail.
run_one 2 1
run_one 2 2
run_one 3 1
run_one 3 2
